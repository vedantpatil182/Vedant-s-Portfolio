  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw(context: CanvasRenderingContext2D) {
        ...
        // Fade in and out based on age, keeping a minimum brightness floor
        const alpha = (1 - Math.abs((this.age / this.life) - 0.5) * 2) * 0.8 + 0.2;
    ...
    const handleVisibilityChange = () => {
      if (document.hidden) {
        ...
        // Let intersection observer re-enable if in view
